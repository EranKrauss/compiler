...
;                  generate applic
push SOB_NIL_ADDRESS ; magic
mov rax, const_tbl +222; insert const from const table to rax
push rax
mov rax, const_tbl +203; insert const from const table to rax
push rax

            push 2  ; number of args
;                  generate applic
push SOB_NIL_ADDRESS ; magic
mov rax, const_tbl +176; insert const from const table to rax
push rax

            push 1  ; number of args
;                  generate applic
push SOB_NIL_ADDRESS ; magic
mov rax, const_tbl +140; insert const from const table to rax
push rax
