...
;                  generate applic
push SOB_NIL_ADDRESS ; magic
mov rax, const_tbl +186; insert const from const table to rax
push rax
mov rax, const_tbl +162; insert const from const table to rax
push rax
mov rax, const_tbl +138; insert const from const table to rax
push rax
mov rax, const_tbl +119; insert const from const table to rax
push rax
mov rax, const_tbl +98; insert const from const table to rax
push rax
...
push rax
 ...
 mov qword [rax+ 80], rdx
 mov qword rdx, [rbx +80]
                                       
 mov qword [rax+ 88], rdx
 push rax
...
push rax
 ...
 mov qword [rax+ 88], rdx
 mov qword rdx, [rbx +88]
                                       
 mov qword [rax+ 96], rdx
 push rax
...
push rax
 ...
 mov qword [rax+ 128], rdx
 mov qword rdx, [rbx +128]
                                       
 mov qword [rax+ 136], rdx
 push rax
...
push rax
 ...
 mov qword [rax+ 144], rdx
 mov qword rdx, [rbx +144]
                                       
 mov qword [rax+ 152], rdx
 push rax
