...
MAKE_LITERAL_RATIONAL(-1,1)
MAKE_LITERAL_FLOAT(0.2)
MAKE_LITERAL_RATIONAL(2,1)
MAKE_LITERAL_FLOAT(0.6667)
MAKE_LITERAL_FLOAT(0.2667)
MAKE_LITERAL_FLOAT(1.)
...
;                  generate applic
push SOB_NIL_ADDRESS ; magic
mov rax, const_tbl +94; insert const from const table to rax
push rax
mov rax, const_tbl +129; insert const from const table to rax
push rax
...
;                  generate applic
push SOB_NIL_ADDRESS ; magic
mov rax, const_tbl +120; insert const from const table to rax
push rax
mov rax, const_tbl +111; insert const from const table to rax
push rax
