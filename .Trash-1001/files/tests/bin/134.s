...
; MALLOC rax, 1; num of params
 ...
 ;                  generate applic tp
push SOB_NIL_ADDRESS ; magic 
mov rax, const_tbl +171; insert const from const table to rax
push rax
mov rax, const_tbl +152; insert const from const table to rax
push rax
mov rax, const_tbl +133; insert const from const table to rax
push rax
mov rax, const_tbl +114; insert const from const table to rax
push rax
mov rax, const_tbl +95; insert const from const table to rax
push rax

            push 5;    push number of rands to stack
             ;                  gen rator
            ;                   generate lambda simple
         MALLOC rax, 16 ; rax is pointer to _ env
