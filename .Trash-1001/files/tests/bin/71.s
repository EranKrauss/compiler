...
;                  generate applic
push SOB_NIL_ADDRESS ; magic
mov rax, const_tbl +161; insert const from const table to rax
push rax
mov rax, const_tbl +144; insert const from const table to rax
push rax
mov rax, const_tbl +127; insert const from const table to rax
push rax

            push 3  ; number of args
;                  generate applic
push SOB_NIL_ADDRESS ; magic
mov rax, const_tbl +110; insert const from const table to rax
push rax
...
; MALLOC rax, 9; num of params
 ...
 ;                  generate ifmov rax, const_tbl +101; insert const from const table to rax
 cmp rax, SOB_FALSE_ADDRESS
...
Exit_applic_410:
 ...
 jmp Lexit408
Lelse35:
mov rax, const_tbl +0; insert const from const table to rax
Lexit408:
             ;                  finish generate if
 leave
