...
{input = ScmApplic (ScmVar "y",  [ScmLambdaSimple (["y"],    ScmSeq     [ScmSet (ScmVar "a", ScmLambdaSimple (["b"], ScmApplic (ScmVar "a", [ScmVar "b"])));      ScmSet (ScmVar "t",       ScmLambdaSimple (["x"],        ScmSeq         [ScmSet (ScmVar "y",           ScmLambdaSimple (["j"], ScmApplic (ScmVar "x", [ScmVar "j"; ScmVar "x"])));          ScmVar "h"]));      ScmApplic (ScmVar "y", [ScmVar "a"])])]); 
