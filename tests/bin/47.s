...
; MALLOC rax, 9; num of params
 ...
 ;                   generate lambda simple
         MALLOC rax, 48 ; rax is pointer to _ env
...
; MALLOC rax, 9; num of params
 ...
 ;                   generate lambda simple
         MALLOC rax, 56 ; rax is pointer to _ env
...
; MALLOC rax, 9; num of params
 ...
 ;                   generate lambda simple
         MALLOC rax, 64 ; rax is pointer to _ env
...
; MALLOC rax, 9; num of params
 ...
 ;                   generate lambda simple
         MALLOC rax, 72 ; rax is pointer to _ env
 ...
 mov qword [rax+ 56], rdx
 mov qword rdx, [rbx +56]
                                       
 mov qword [rax+ 64], rdx
 push rax ; save pointer to _ env
