...
;                      generate define
mov rax, const_tbl +99; insert const from const table to rax
...
mov [fvar_tbl+49*WORD_SIZE], rax ; insert var to free var table
mov rax, SOB_VOID_ADDRESS ; define return void
          ;                       finish generate def
	call write_sob_if_not_void
...
Exit_applic_410:
            ;                     finish generate applic
mov [fvar_tbl+50*WORD_SIZE], rax ; insert var to free var table
mov rax, SOB_VOID_ADDRESS ; define return void
          ;                       finish generate def
	call write_sob_if_not_void
