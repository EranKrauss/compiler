...
;                  generate applic
push SOB_NIL_ADDRESS ; magic
mov rax, const_tbl +104; insert const from const table to rax
push rax
mov rax, const_tbl +34; insert const from const table to rax
push rax
...
;                  generate applic
push SOB_NIL_ADDRESS ; magic
mov rax, const_tbl +106; insert const from const table to rax
push rax
mov rax, const_tbl +51; insert const from const table to rax
push rax
mov rax, qword [fvar_tbl + 384]
...
;                  generate applic
push SOB_NIL_ADDRESS ; magic
mov rax, const_tbl +125; insert const from const table to rax
push rax
mov rax, const_tbl +108; insert const from const table to rax
push rax
mov rax, qword [fvar_tbl + 384]
push rax
