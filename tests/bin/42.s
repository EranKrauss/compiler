...
;                  generate applic
push SOB_NIL_ADDRESS ; magic
mov rax, const_tbl +147; insert const from const table to rax
push rax
mov rax, const_tbl +130; insert const from const table to rax
push rax
mov rax, const_tbl +51; insert const from const table to rax
push rax
...
mov rax, const_tbl +1; insert const from const table to rax
push rax
mov rax, const_tbl +121; insert const from const table to rax
push rax
